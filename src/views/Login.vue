          ...
          <div class="formSB" :style="sStyle">
            ...
            <div>
              <p style="position:absolute;top:200px;left:105px;color:#000">
                打开<a href="javascript:;" style="color:red;text-decoration:none">手机京东</a>&nbsp;&nbsp;&nbsp;扫描二维码
              </p>
            </div>
...
<style scoped>
  ...
  .formS a{border-right: 1px solid #F4F4F4}
  .formZ a{border-left: 1px solid #F4F4F4}
  .formS a:hover,.formZ a:hover{
    font-weight: bolder;
    color:#e4393c
  }
  .checked a{
  ...
  .formZB .passWd{margin-top:30px;}
  .formZB input{
    width:224px;
    display: inline-block;
    height:18px;line-height: 18px;
    border:1px solid #bdbdbd;outline: 0;
